...
angular.module('tm.pagination', []).directive('tmPagination',[function(){
    return {
        restrict: 'EA',
        template: '<div class="page-list col-md-12" style="padding-bottom:6px;">' +
            '<ul style="display:inline" class="pagination" ng-show="conf.totalItems > 0">' +
            ...
            '</ul>' +
            '<div style="text-align:left;padding-top:4px;float:left;padding-left:10px" class="page-total" ng-show="conf.totalItems > 0">' +
