...
public class AppMessageSettings implements Serializable {

	/**
	 */
	private static final long serialVersionUID = 1994089780605935601L;
	...
	/**
	 * 通知消息点击跳转网页链接，网页链接模板类型时有效
	 */
	private String linkUrl;

	/**
	 * 消息模板类型 1：点击打开应用 2：点击打开网页 3：点击打开弹窗下载 4：透传消息模板
	 */
	...
	private String autoBadge;// 角标 -1：数字减1 +1:角标+1
