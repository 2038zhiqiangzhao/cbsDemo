...
public class HttpUtils {
	 ...
	 * @return
	 */
	public String sendPostMessage(Map<String, Object> params, String pathUrl,
			String account, String currentData) {

		MD5Util md5Util = MD5Util.getInstance();
		String authorization = md5Util
				.base64Encode(account + ":" + currentData);
