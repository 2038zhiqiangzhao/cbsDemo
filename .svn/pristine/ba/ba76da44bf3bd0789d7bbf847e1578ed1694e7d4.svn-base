...
import com.people2000.user.model.enums.WebSiteFileBelongEnum;
...
public class UserUtils {
	...
	/** 系统默认头像 */
	private static String[] defaultAvatar = { "avatar_1.jpg", "avatar_2.jpg",
			"avatar_3.jpg", "avatar_4.jpg", "avatar_5.jpg", "avatar_6.jpg",
			"avatar_7.jpg", "avatar_8.jpg" };
