...
public class UserRelateInfoDAOWriteImpl implements UserRelateInfoDAOWrite {
	/**
	 ...
	 * @abatorgenerated Sun Aug 28 14:41:27 CST 2016
	 */
	public Long insert(UserRelateInfoPO record) throws SQLException {
		Object newKey = sqlMapClient.insert(
				"u_user_relate_info.abatorgenerated_insert", record);
		return (Long) newKey;
	}
	 ...
	 * @abatorgenerated Sun Aug 28 14:41:27 CST 2016
	 */
	public int updateByPrimaryKeySelective(UserRelateInfoPO record)
			throws SQLException {
		int rows = sqlMapClient
				.update("u_user_relate_info.abatorgenerated_updateByPrimaryKeySelective",
						record);
		return rows;
	}
	 ...
	 * @abatorgenerated Sun Aug 28 14:41:27 CST 2016
	 */
	public int updateByExampleSelective(UserRelateInfoPO record,
			UserRelateInfoPOExample example) throws SQLException {
		UpdateByExampleParms parms = new UpdateByExampleParms(record, example);
		int rows = sqlMapClient.update(
				"u_user_relate_info.abatorgenerated_updateByExampleSelective",
				parms);
		return rows;
	}
