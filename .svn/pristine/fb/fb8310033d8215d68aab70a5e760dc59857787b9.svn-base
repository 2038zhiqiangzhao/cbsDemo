package com.people2000.platform.business.utils;
...
import com.people2000.platform.model.dto.AppMessageDto;
...
public class AppMessageUtils {
	...
	public static ITemplate createTemplate(AppMessageDto appMessage) {
	 ...
	 * @see
	 */
	public static LinkTemplate createLinkTemplate(AppMessageDto appMessage) {
	 ...
	 * @see
	 */
	public static ITemplate createNotyPopLoadTemplate(AppMessageDto appMessage) {
	 ...
	 * @see
	 */
	public static ITemplate createTransmissionTemplate(AppMessageDto appMessage) {
		...
		payload.setAlertMsg(new APNPayload.SimpleAlertMsg(appMessage
