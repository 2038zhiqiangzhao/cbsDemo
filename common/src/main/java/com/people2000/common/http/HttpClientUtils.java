package com.people2000.common.http;
...
/**
 * 依赖的jar包有：commons-lang-2.6.jar、httpclient-4.3.6.jar、httpcore-4.3.1.jar、commons
 * -io-2.4.jar
 * 
 * @author dusai
 *
...
public class HttpClientUtils {
	...
	private static SSLConnectionSocketFactory customeSslsf = null;
	...
	public static void initCustomeSslsf(SSLConnectionSocketFactory sslsf) {
		customeSslsf = sslsf;
	}
	...
	private static CloseableHttpClient createSSLInsecureClient()
		...
		try {
			...
			if (customeSslsf == null) {
				customeSslsf = sslsf;
			}

			return HttpClients.custom().setSSLSocketFactory(customeSslsf)
					.build();
	...
	public static void main(String[] args) {
		try {
			String str = post("https://localhost:443/ssl/test.shtml",
					"name=12&page=34", "application/x-www-form-urlencoded",
					"UTF-8", 10000, 10000);
			// String str=
